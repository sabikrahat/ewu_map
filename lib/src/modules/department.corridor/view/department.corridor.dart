...
// import '../../floor.design/provider/floor.design.provider.dart';
...
// class DepartmentCorridor extends ConsumerWidget {
//   const DepartmentCorridor({super.key, required this.floor});
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Department Corridor Live Trace'),
//         actions: [
